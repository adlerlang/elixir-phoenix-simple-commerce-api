...
product = [%{upc: "1-23432-43453-74343-0", order_id: 1, name: "ice cream",  desc: "pint of ice cream", price: 4.33, weight: 32.1, quantities: 1},
...
customer2 = %{customer_id: 2, customer_fname: "sarah", customer_lname: "me", customer_address: "3434 s 43 st, Orlando, Florida", customer_phone: "854-645-3434", orders: order2 }
